...
module.exports = {
    seed: (req, res) => {
        ...
        values('Notorious B.I.G', NULL, 'https://miro.medium.com/max/750/1*YGdpRUmRKtYoQujQSQtw_w@2x.jpeg' ),
        ('Greg Universe', NULL, 'https://www.denofgeek.com/wp-content/uploads/2020/03/Steven-Universe-Future-Greg-Universe.png?resize=768%2C432'),
        ('Malcolm X', NULL, 'https://media-cldnry.s-nbcnews.com/image/upload/newscms/2020_37/3410610/200908-malcolm-x-ew-438p-3410610.jpg');
        ...
        Remember when I used to eat sardines for dinner', 1),
        ...
        UPDATE artist_card SET quote_id = 1 where artist_id = 1;
        UPDATE artist_card SET quote_id = 2 where artist_id = 2;
        UPDATE artist_card SET quote_id = 3 where artist_id = 3;
